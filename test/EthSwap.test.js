...
contract('EthSwap',([deployer,investor])=> {
    ...
    describe('buyTokens()', async()=>{
        ...
        it('Allows users to instantly purchase tokens for ethSwap for a fixed price',async()=> {
            ...
            assert.equal(ethSwapEtherBalance,tokens('1'))
    ...
    describe('sellTokens()',async()=>{
        ...
        it('Allow users to instantly sell tokens to ethSwap for a fixed price',async()=> {
